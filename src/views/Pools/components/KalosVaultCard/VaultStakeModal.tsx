...
import { Modal, Text, Flex, Image, Button, Slider, BalanceInput, AutoRenewIcon } from '@kalosdefi/uikit'
...
import { convertXaloToShares } from '../../helpers'
...
const VaultStakeModal: React.FC<VaultStakeModalProps> = ({ pool, stakingMax, isRemovingStake = false, onDismiss }) => {
  ...
  const handleWithdrawal = async (convertedStakeAmount: BigNumber) => {
    setPendingTx(true)
    const shareStakeToWithdraw = convertXaloToShares(convertedStakeAmount, pricePerFullShare)
    // trigger withdrawAll function if the withdrawal will leave 0.000001 XALO or less
  ...
  return (
    ...
    >
      ...
      <BalanceInput
        ...
        currencyValue={xaloPriceBusd.gt(0) && `~${usdValueStaked || 0} USD`}

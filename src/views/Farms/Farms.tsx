...
import { Image, Heading, RowType, Toggle, Text, Flex } from '@kalosdefi/uikit'
import { ChainId } from '@kalosdefi/kalos-sdk'
import styled from 'styled-components'
import FlexLayout from 'components/Layout/Flex'
import Page from 'components/Layout/Page'
import { useFarms, usePollFarmsData, usePriceXaloBusd } from 'state/farms/hooks'
...
const Farms: React.FC = () => {
  ...
  const xaloPrice = usePriceXaloBusd()
  ...
  const activeFarms = farmsLP.filter((farm) => farm.pid !== 0 && farm.multiplier !== '1X' && !isArchivedPid(farm.pid))
  ...
  const rowData = chosenFarmsMemoized.map((farm) => {
    ...
    const lpLabel = farm.lpSymbol && farm.lpSymbol.split(' ')[0].toUpperCase().replace('XALOS', '')
